    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Клиент'),
                 ('supplier', 'Поставщик')], default='customer', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Ожидание'), ('processing', 'В обработке'), (
                    'shipped', 'Отправлен'), ('delivered', 'Доставлен'), ('cancelled', 'Отменен')], default='pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE,
                 related_name='supplier_profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='product',
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                    related_name='products', to='shop.supplier'),
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
